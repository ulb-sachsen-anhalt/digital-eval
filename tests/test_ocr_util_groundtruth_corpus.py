...
def test_gt2mets_initialization_with_valid_args(mock_gt_files, mock_output_dir, mock_temp_dir):
...
def test_cli_groundtruth_corpus_success_message(
    ...
    # assert
    captured = capsys.readouterr()
    assert 'completed successfully' in captured.out or 'completed successfully' in captured.err
